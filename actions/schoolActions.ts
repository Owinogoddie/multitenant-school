import { PrismaClient, School, Subscription } from '@prisma/client';
import { generateUniqueSubdomain } from '@/lib/subdomainGenerator';
import { getFreePlan, calculateSubscriptionEndDate, getSubscriptionStatus } from '@/lib/subscriptionUtils';
